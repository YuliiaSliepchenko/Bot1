...
async def chat(req: ChatRequest):
    ...
    if any(x in msg_lower for x in ["проходили", "вже пробували", "пробували"]):
        return {
            "response": (
                "Якщо вже спробували інший формат, можу запропонувати інші варіанти:\n"
                "• Constract — блочне програмування високого рівня\n"
                "• Minecraft + Python — блочне програмування із плавним переходом на Python\n\n"
                "Це допоможе перейти від візуального створення до програмування без різкого стрибка."
            )
        }
    ...
    try:
        ...
        if not sent_to_meta:
            return {
                ...
                "warning": (
                    "Файл збережено в CRM, але Meta не прийняла "
                    "цей тип файлу для Instagram Direct."
                ),
                "details": data,
                "file": {
                    "name": saved_file["original_name"],
        ...
        return {
            "success": True,
            "sent_to_meta": True,
            "message": "Файл в Instagram Direct надіслано.",
            "message_id": message_id,
            "instagram_id": clean_instagram_id,
            "participant_id": clean_participant_id,
            "file": {
